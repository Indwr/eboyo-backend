...
let allPaymentGeteway = async (payloadData, UserData) => {
...
let addPaymentGeteway = async (payloadData, UserData) => {
  try {
    ...
    let createPaymentGeteway = await Service.PaymentGetewayService.InsertData(
      data
    );
...
let editPaymentGeteway = async (payloadData, userData) => {
  ...
  let projection = { __v: 0 };
  try {
    let paymentGetewayData = await Service.PaymentGetewayService.getData(
      criteria,
      projection,
      {
        lean: true,
