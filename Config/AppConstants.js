...
let SEND_GRID_DETAILS = {
  //SendgridTransport
  HOST: "smtp.sendgrid.net",
  FROM: "kushmalout@gmail.com",
  SMTP_USER: "deondeApp",
  SMTP_PASSWORD:
    "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",
};
...
let FCM_KEY =
  "AAAAv7Krntg:APA91bFGdjobNI0oLuwQy19hrPJMCg1gUnUilgVuEnUCwBgnDaYjVaEkgneHluH8HouhBccvUhdGcNJ3-RF0IJc8jekDlcERA0IU8ZpKuLXOMoJlspuQ0zNLVRrJ4hiuk-uwBQpJRH9b";
...
let STATUS_MSG = {
  ...
  ERROR: {
    ...
    AMOUNT_NOT_SUFFICIENT: {
      statusCode: 400,
      customMessage:
        "Entered amount not sufficient please check and try again later...",
