/**
 * Created by Indersein on 25/02/2021.
 */
...
const TransactionTableSchema = new Schema({
  ...
  paymentType: {
    type: String,
    enum: [PAYMENT_TYPES.RAZORPAY, PAYMENT_TYPES.CASH],
  },
...
TransactionTableSchema.plugin(AutoIncrement, {
  inc_field: "transactionIncrementId",
});
